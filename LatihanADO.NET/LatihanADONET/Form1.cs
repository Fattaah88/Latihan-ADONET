    ...
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try // penggunaan blok try-catch untuk penanganan error
            {
                ...
                string dbName = @"E:\22.11.4814\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
                // deklarasi variabel connectionString, refhttps://www.connectionstrings.com/
        ...
        {
            {
                ...
                if (result > 0)
                {
                    MessageBox.Show("Apakah data mahasiswa ingin dihapus ?", "Informasi",
                   MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
                    // reset form
                    txtNpmDelete.Clear();
                    ...
                    MessageBox.Show("Data mahasiswa gagal didelete !!!", "Informasi",
                   MessageBoxButtons.OK,
                    MessageBoxIcon.Exclamation);
                // setelah selesai digunakan, 
                // segera hapus objek connection dari memory
